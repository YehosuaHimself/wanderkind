  ...
  return (
    <SafeAreaView style={styles.container} edges={['top']}>
      ...
      <ScrollView contentContainerStyle={styles.content}>
        ...
        <Text style={styles.h1}>Pin & Gate Code</Text>
        <Text style={styles.lead}>Sensitive access details — door pin, key under the third stone, garden gate combo — revealed only to a confirmed walker within 24 hours of arrival.</Text>

        <View style={styles.card}>
          <View style={styles.row}>
            <Ionicons name="hammer-outline" size={16} color={colors.amber} />
            <Text style={styles.rowText}>New host_access_secrets table with strict RLS. Encrypted at rest. Auto-redacted from client logs. Designed for the pattern: a Wanderhost out walking themselves still hosts safely.</Text>
          </View>
          <View style={styles.divider} />
          <View style={styles.row}>
            <Ionicons name="git-branch-outline" size={16} color={colors.amber} />
            <Text style={styles.rowText}>Tracked as <Text style={styles.mono}>WK-124</Text> in the v1.1 refinement EPIC.</Text>
          </View>
          <View style={styles.divider} />
          <View style={styles.row}>
