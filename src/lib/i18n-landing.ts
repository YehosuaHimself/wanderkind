...
const en: Translations = {
  ...
  guideStep2Desc: 'Scroll down in the share menu and tap it',
  ...
  beginBtn: 'BEGIN YOUR WAY',
  signinLink: 'I already have a pass',
...
const de: Translations = {
  ...
  guideStep2Desc: 'Scrolle im Teilen-Menü nach unten und tippe darauf',
  ...
  beginBtn: 'BEGINNE DEINEN WEG',
  signinLink: 'Ich habe bereits einen Pass',
...
const es: Translations = {
  ...
  guideStep2Desc: 'Desplázate en el menú de compartir y tócalo',
  ...
  beginBtn: 'COMIENZA TU CAMINO',
  signinLink: 'Ya tengo un pase',
...
const fr: Translations = {
  ...
  guideStep2Desc: 'Fais défiler le menu de partage et appuie',
  ...
  beginBtn: 'COMMENCE TON CHEMIN',
  signinLink: "J'ai déjà un pass",
...
const pt: Translations = {
  ...
  guideStep2Desc: 'Desliza no menu de partilha e toca',
  ...
  beginBtn: 'COMEÇA O TEU CAMINHO',
  signinLink: 'Já tenho um passe',
...
const it: Translations = {
  ...
  guideStep2Desc: 'Scorri nel menu di condivisione e toccalo',
  ...
  beginBtn: 'INIZIA IL TUO CAMMINO',
  signinLink: 'Ho già un pass',
...
const nl: Translations = {
  ...
  guideStep2Desc: 'Scroll in het deelmenu en tik erop',
  ...
  beginBtn: 'BEGIN JE WEG',
  signinLink: 'Ik heb al een pas',
